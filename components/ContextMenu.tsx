...
export default function ContextMenu(
  ...
  return (
    <menu
      ref={contextMenuRef}
      className="absolute min-w-[12rem] z-10 py-3 shadow-lg shadow-gray-900 bg-zinc-800 text-lg text-gray-200 rounded-md border-black border-solid border-[1px] context-menu"
    >
